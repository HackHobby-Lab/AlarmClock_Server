...
lastEncoderValue = encoderValue;
  ...
  if (nowHour12 == 0) nowHour12 = 12;  // Adjust for 12-hour format
...
void changeSettingValue(int delta) {
  switch (settingMode) {
    ...
    case 1:  // Hour
      ...
      if (settingValue == 0) settingValue = 12;
...
void setTimeNow(int delta) {
  ...
  switch (timeSetting) {
    ...
    case 4:  // Finalize time setting
      if (isPM && adjustedHH != 12) adjustedHH += 12;
      if (!isPM && adjustedHH == 12) adjustedHH = 0;
    ...
    case 7:  // Day
      ...
      if (settingValue == 0) {settingValue = 31;}
